...
const createMesh =  () => {
  ...
  cube = new THREE.Mesh(cubeGeomtry, cubeMaterial)
...
const moveMesh = () => {
  cube.rotation.set(
    Math.sin(x_position * Math.PI / 180),
    0,
    Math.cos(z_position * Math.PI / 180)
  )
  cube.position.set(
    10 * Math.cos(x_position * Math.PI / 180),
    15,
    30 * Math.sin(z_position * Math.PI / 180)
  )
}
